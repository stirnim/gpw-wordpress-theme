...
<?php pll_the_languages( array( 
    ...
    'display_names_as' => 'slug' 
                ...
                <div class="mobile-social-media">
                    <a href="<?php echo esc_url(get_theme_mod('footer_facebook_link', 'https://www.facebook.com/wintimarathon')); ?>"><img src="<?php echo esc_url(get_theme_mod('footer_facebook_icon', get_stylesheet_directory_uri() . '/images/facebook_lime.svg')); ?>" alt="Facebook"></a>
                    <a href="<?php echo esc_url(get_theme_mod('footer_instagram_link', 'https://www.instagram.com/wintimarathon/')); ?>"><img src="<?php echo esc_url(get_theme_mod('footer_instagram_icon', get_stylesheet_directory_uri() . '/images/instagram_lime.svg')); ?>" alt="Instagram"></a>
                </div>
                <!-- Footer Links -->
